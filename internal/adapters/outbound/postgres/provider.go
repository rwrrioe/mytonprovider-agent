...
//func (r *Provider) GetProvidersByPubkeys(ctx context.Context, pubkeys []string) (resp []db.ProviderDB, err error) {
//	query := `
//		SELECT
//			p.public_key,
//			p.address,
...
//}
//
//func (r *Provider) GetFilteredProviders(ctx context.Context, filters db.ProviderFilters, sort db.ProviderSort, limit, offset int) (resp []db.ProviderDB, err error) {
...
//}
//
//func (r *Provider) GetFiltersRange(ctx context.Context) (filtersRange db.FiltersRange, err error) {
//	query := `
//		SELECT
//			-- Provider ranges
...
//}
//
//func (r *Provider) UpdateTelemetry(ctx context.Context, telemetry []db.TelemetryUpdate) (err error) {
//	if len(telemetry) == 0 {
//		return
//	}
//
...
//}
//
//func (r *Provider) UpdateBenchmarks(ctx context.Context, benchmarks []db.BenchmarkUpdate) (err error) {
//	if len(benchmarks) == 0 {
//		return
//	}
//
...
//}
//
//func (r *Provider) AddStatuses(ctx context.Context, providers []db.ProviderStatusUpdate) (err error) {
//	if len(providers) == 0 {
//		return
//	}
//
...
//}
//
//func (r *Provider) UpdateProvidersIPs(ctx context.Context, ips []db.ProviderIP) (err error) {
//	if len(ips) == 0 {
//		return
//	}
//
...
//}
//
//func (r *Provider) UpdateUptime(ctx context.Context) (err error) {
//	query := `
...
//}
//
//func (r *Provider) UpdateRating(ctx context.Context) (err error) {
//	query := `
//		WITH params AS (
//			SELECT
//				p.public_key,
...
func (r *ProviderRepo) GetAllPubkeys(ctx context.Context) ([]string, error) {
	const op = "postgres.ProviderRepo.GetAllPubkeys"
...
func (r *ProviderRepo) GetAllWallets(ctx context.Context) ([]domain.Provider, error) {
	const op = "postgres.ProviderRepo.GetAllWallets"

	rows, err := r.db.Query(ctx, `
		SELECT public_key, address, last_tx_lt
		FROM providers.providers
	`)
	if err != nil {
		if errors.Is(err, pgx.ErrNoRows) {
	...
	for rows.Next() {
		...
		if err = rows.Scan(&p.PublicKey, &p.Address, &p.LT); err != nil {
			return nil, fmt.Errorf("%s:%w", op, err)
		}
...
//func (r *Provider) AddStorageContracts(ctx context.Context, contracts []db.StorageContract) (err error) {
//	if len(contracts) == 0 {
//		return
//	}
//
...
//}
//
//func (r *Provider) UpdateStatuses(ctx context.Context) (err error) {
//	query := `
//		UPDATE providers.providers p
...
//}
//
//func (r *Provider) GetStorageContractsChecks(ctx context.Context, contracts []string) (resp []db.ContractCheck, err error) {
//	query := `
//		SELECT
//			sc.address,
//			p.public_key,
...
//}
//
//func (r *Provider) UpdateContractProofsChecks(ctx context.Context, contractsProofs []db.ContractProofsCheck) (err error) {
//	query := `
//		WITH cte AS (
//			SELECT
...
//}
//
//func (r *Provider) GetStorageContracts(ctx context.Context) (contracts []db.ContractToProviderRelation, err error) {
//	query := `
//		SELECT
...
//}
//
//func (r *Provider) UpdateRejectedStorageContracts(ctx context.Context, storageContracts []db.ContractToProviderRelation) (err error) {
...
func (r *ProviderRepo) UpdateLT(ctx context.Context, providers []domain.Provider) error {
	const op = "postgres.ProviderRepo.UpdateLT"

	if len(providers) == 0 {
		return nil
	}

	dtos := make([]providerLTDTO, len(providers))
	for i, p := range providers {
		dtos[i] = providerLTDTO{
